...
import { TreeKhoNoiTru, dataDsPhieuKhoNoiTru } from '../../consts/PhanHeKhoDuocConst';
import InputSearch from '../../../component/InputSearch';
import CombinedTable from './../../../component/table/combined-table/CombinedTable';
import { dsPhieuKhoNoiTruColumn } from '../../consts/Columns';

type Props = {}

const TabKhoNoiTru = (props: Props) => {
            ...
            <div className="kho-noi-tru-content">
                ...
                <div className='spaces width-80 bg-white p-10'>
                    ...
                    <div className='table-ds-phieu'>
                        ...
                        <CombinedTable userColumns={dsPhieuKhoNoiTruColumn} data={dataDsPhieuKhoNoiTru} height={"calc(100vh - 225px)"} />
                    </div>
