      ...
      <Modal.Body>
        ...
        <div className="row mt-3">
          ...
          <div className="col-4 d-flex align-items-center">
            ...
            <input
              type="number"
              className="form-control customs-input w-80px"
              value={"100"}
              disabled
            />
          </div>
        ...
        <div className="row mt-3">
          ...
          <div className="col-4 d-flex align-items-center">
            ...
            <input
              type="text"
              className="form-control customs-input min-w-80px"
        ...
        <div className="row mt-3">
          <div className="col-6 d-flex align-items-center">
            ...
            <TableCustomV2<any> data={phuMoData} columns={PhuMoColumns} />
          </div>
          <div className="col-6 d-flex align-items-center">
            <div className="min-w-150px"></div>
            <TableCustomV2<any> data={phuMeData} columns={PhuMeColumns} />
          </div>
        </div>
        <div className="row mt-3">
          <div className="col-6 d-flex align-items-center">
