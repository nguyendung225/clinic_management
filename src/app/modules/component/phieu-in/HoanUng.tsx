...
import {
  getDataPhieu,
  getChiTietThanhToan,
} from "../../phan-he-tiep-nhan-thanh-toan/services/ThanhToanServices";
import { CODE, ERROR_MESSAGE, RESPONSE_MESSAGE } from "../../utils/Constant";
import { toast } from "react-toastify";
import { AppContext } from "../../appContext/AppContext";
import { thanhToan } from "../../phan-he-tiep-nhan-thanh-toan/models/ThanhToanModel";
import { initialValuesThanhToan } from "../../phan-he-tiep-nhan-thanh-toan/constants/constants";
...
const HoanUng: FC<PropsHoaDon> = (props) => {
  ...
  let tienHoanUng =
    dataPhieu?.totalMoney && dataPhieu?.paidMoney
      ? dataPhieu?.paidMoney - dataPhieu?.totalMoney
      : 0;
    ...
    <>
      ...
      >
        <Modal.Header closeButton className="header-modal">
          <Modal.Title>Biên lai hoàn ứng</Modal.Title>
        </Modal.Header>
        <iframe
            ...
            <Container fluid>
              ...
              <Row style={{ ...st.row, ...st.mt_5 }}>
                <Col style={st.col_5} lg={5}>
                  ...
                  <div style={{ ...st.position_relative, ...st.w[79] }}>
                    <div>&nbsp;{convertNumberPrice(tienHoanUng)}</div>
                    <div style={st.dotted}></div>
                  </div>
                </Col>
              ...
              >
                ...
                <Col lg="6" style={{ ...st.col_6, ...st.text_center }}>
                  ...
                  <div style={st.fw_bold}>Người hoàn ứng</div>
