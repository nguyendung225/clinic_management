                            ...
                            <div style={{ ...styles.d_flex, lineHeight: "20px" }}>
                                <div style={{ ...styles.w_100 }}>
                                    <span
                                        ...
                                        <strong style={{ fontSize: "18px" }}>KẾT QUẢ NỘI SOI</strong>
                                        <i style={{marginLeft: "20px"}}>(loại máy soi, thuốc dùng)</i>
                                    </span>
                                    <CustomTextarea
                                        disabled
                                        rows={10} />
                            ...
                            <div style={{ ...styles.d_flex, lineHeight: "20px" }}>
                                <div style={{ ...styles.w_100 }}>
                                    <span
                                        className="mb-6px"
                                        style={{ marginBottom: "-2px", width: "200px" }}>
                                        <strong style={{ fontSize: "18px" }}>KẾT LUẬN:</strong>
                                    </span>
                                    <CustomTextarea
                                        disabled
                                        rows={4} />
