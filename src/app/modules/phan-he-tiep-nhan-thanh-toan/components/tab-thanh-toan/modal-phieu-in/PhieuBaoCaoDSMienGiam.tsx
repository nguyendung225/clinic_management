...
const PhieuBaoCaoDSMienGiam = (props: Props) => {
  return (
    <div>
      <div style={styles.marginBottom._10px}>
        <div style={{ ...styles.fontBold, ...styles.fontSize._24px, ...styles.textAlign.center }}>BÁO CÁO DANH SÁCH MIỄN GIẢM</div>
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              ...
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._65px }} rowSpan={2}>ID Phiếu</th>
              ...
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._70px }} rowSpan={2}>Loại phiếu</th>
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._85px }} rowSpan={2}>Hình thức phiếu thu</th>
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._100px }} rowSpan={2}>Số tiền</th>
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._200px }} rowSpan={2}>Lý do</th>
            </tr>
          ...
          <tbody>
            <tr>
              <td style={{ ...styles.border1, ...styles.fontBold }} colSpan={10}>TỔNG CỘNG</td>
...
export default PhieuBaoCaoDSMienGiam