...
const PhieuBaoCaoDSThuTien = (props: Props) => {
  return (
    <div>
      <div style={styles.marginBottom._10px}>
        <div style={{ ...styles.fontBold, ...styles.fontSize._24px, ...styles.textAlign.center }}>DANH SÁCH PHIẾU THU TIỀN</div>
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              ...
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._70px }} rowSpan={2}>Số HDDT</th>
              ...
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._100px }} rowSpan={2}>Miễn giảm</th>
              <th style={{ ...styles.border1, ...styles.textAlign.center, ...styles.minWidth._100px }} rowSpan={2}>Thực thu</th>
            </tr>
...
export default PhieuBaoCaoDSThuTien