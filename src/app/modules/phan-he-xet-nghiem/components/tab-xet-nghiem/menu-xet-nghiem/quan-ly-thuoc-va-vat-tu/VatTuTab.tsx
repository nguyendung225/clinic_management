...
import { columnsDanhSachVatTu } from '../../../../const/Columns'

type Props = {}

const VatTuTab = (props: Props) => {
    return (
        <>
            <Row>
                <Col
            ...
            <CombinedTable userColumns={columnsDanhSachVatTu} data={[]} height={"calc(100vh - 395px)"} />

        </>
    )
}

export default VatTuTab