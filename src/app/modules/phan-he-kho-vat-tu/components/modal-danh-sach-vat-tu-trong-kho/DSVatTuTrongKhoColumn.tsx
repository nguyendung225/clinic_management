...
export const vatTuTrongKhoColumn: ReadonlyArray<Column<IVatTuTrongKho>> = [
  {
    Header: (props) => (
      <TableCustomHeader
        tableProps={props}
  ...
  },
  {
    ...
    Cell: ({ ...props }) => (
      <TableCustomCell
        tableProps={props}
        data={props?.row?.original?.soHopDong}
      />
    ),
  },
  {
    ...
    Cell: ({ ...props }) => (
      <TableCustomCell
        tableProps={props}
        data={props?.row?.original?.ngayHopDong}
      />
    ),
  },
  {
  ...
  },
  {
    ...
    Cell: ({ ...props }) => (
      <TableCustomCell
        tableProps={props}
        className="text-end"
        data={props?.row?.original?.dongBang}
      />
    ),
  },
  {
  ...
  },
  {
    ...
    Cell: ({ ...props }) => (
      <TableCustomCell
        tableProps={props}
        data={props?.row?.original?.phongLuu}
      />
    ),
  },
  {
...
export const phongLuuColumn: ReadonlyArray<Column<any>> = [
  {
    Header: (props) => (
      <TableCustomHeader
        tableProps={props}
  ...
  },
  {
    ...
    Cell: ({ ...props }) => (
      <TableCustomCell
        tableProps={props}
        data={props?.row?.original?.tenPhong}
      />
    ),
  },
] 