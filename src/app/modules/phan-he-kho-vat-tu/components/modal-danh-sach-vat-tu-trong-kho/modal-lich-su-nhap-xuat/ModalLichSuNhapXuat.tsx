...
import TableLichSuNhapXuat from './TableLichSuNhapXuat';
...
const ModalLichSuNhapXuat = ({ show, handleCloseDialog }: Props) => {
      ...
      <Modal.Body className="p-0 spaces bg-white overflow-hidden">
        <Row className='border-bottom py-1'>
          ...
          <Col xs={9} className='d-flex justify-content-end align-items-center gap-4'>
            <FormCheck type='checkbox' label="Gộp thuốc cùng mã" />
...
export default ModalLichSuNhapXuat